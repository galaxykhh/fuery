...
- `fuery` and `fuery_core` are released together with the same version and follow semver: a breaking change bumps the major version, so prefer additions, and keep what is public public.
