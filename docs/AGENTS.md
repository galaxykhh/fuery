...
- Sections: Getting started, Concepts (what server state is, how the cache works, and how to organize queries), Guides (one page per feature), Reference (every option in a table), Troubleshooting (symptom, cause, fix).
