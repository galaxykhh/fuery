...
| [`fuery_hooks`](packages/fuery_hooks) | `useQuery`, `useInfiniteQuery`, `useMutation`, and `useQueries` for [`flutter_hooks`](https://pub.dev/packages/flutter_hooks). Re-exports `fuery`. |
