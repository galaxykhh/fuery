...
- `useOnQueryChange` given a result that no observer reported (built with the `QueryResult` constructor) fails an assert; in a release build it listens to nothing.
